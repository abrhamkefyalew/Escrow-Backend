...
return [
     ...
     */
    // 'temporary_upload_model' => Spatie\MediaLibraryPro\Models\TemporaryUpload::class,        // COMMENTED BECAUSE = i am NOT using Media Library Pro
    'temporary_upload_model' => null,
            //
            // I am NOT using the Pro version, so I set 'temporary_upload_model' to null.
